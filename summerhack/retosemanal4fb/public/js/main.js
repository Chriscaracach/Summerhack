...
function renderCartas(){
    ...
    for(let i=0;i<seisCartas.length;i++){
        ...
        img.setAttribute("style", "height: 350px; width: 200px") 
        ...
        //prueba, creamos un h5 para el indicador de carta
...
function remover(){
    ...
    let match__si = document.querySelector("#match__si")
    let match__no = document.querySelector("#match__no")
    //multiples for para eliminar, un bajon
...
// let ppal__btnver = document.querySelectorAll(".btn-ver")

// for(let i=0;i<ppal__btnver.length;i++){
//     ppal__btnver[i].setAttribute("on-click", "ver()")
// }
